...
import { Mail, Lock, Eye, EyeOff, ChefHat, ArrowLeft } from 'lucide-react-native';
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.form}>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>Don't have a restaurant account? </Text>
          <Link href="/(restaurant-auth)/register" asChild>
            <TouchableOpacity>
        ...
        <View style={styles.customerLink}>
          <Text style={styles.customerLinkText}>Looking to order food? </Text>
